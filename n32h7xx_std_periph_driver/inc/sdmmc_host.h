 ...
 *\*\brief SD/MMC host driver header for SD card and eMMC device support
 **/
...
/* Interrupt-driven (IT) transfer functions */
void SD_IRQHandler_IT(sd_card_t *card);        /* Called from platform IRQ handler */
