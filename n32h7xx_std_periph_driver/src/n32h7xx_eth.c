...
#define ETH_MACL3L4F0CTRL_MASK                  ((uint32_t)0x003DFFFDU)
#define ETH_MACL3L4F1CTRL_MASK                  ((uint32_t)0x003DFFFDU)
...
#define ETH_MACVLANTAG_MASK                     ((uint32_t)0xBF7FFFFFU)
#define ETH_MACVLANINC_MASK                     ((uint32_t)0x001FFFFFU)
#define ETH_MACIVLANINC_MASK                    ((uint32_t)0x001FFFFFU)
#define ETH_MACLPICTRLSTS_MASK                  ((uint32_t)0x00290000U)
...
void ETH_StructInit(ETH_Module* ETHx, ETH_InitType* ETH_InitParam)
{
    ...
    ETH_InitParam->DeferralCheck             = (uint32_t)DISABLE;
    ...
    ETH_InitParam->JumboPacket               = (uint32_t)DISABLE;
    /* Default Enable Jabber timer on Tx path */
    ETH_InitParam->DisTxJabber               = (uint32_t)DISABLE;
    /* Default Disable Packet Burst, Only ETH1 supports */
    ETH_InitParam->PacketBurst               = (uint32_t)DISABLE;
    /* Default Enable Watchdog timer on Rx path */
    ETH_InitParam->DisRxWatchdog             = (uint32_t)DISABLE;
    /* Default Disable Automatic Pad or CRC Stripping function */
    ETH_InitParam->AutoPadCRCStrip           = (uint32_t)DISABLE;
    /* Default Disable CRC stripping for Type packets function */
    ETH_InitParam->CRCStripTypePacket        = (uint32_t)DISABLE;
    /* Default Disable IEEE 802.3as Support for 2K Packets function */
    ETH_InitParam->Support2KPacket           = (uint32_t)DISABLE;
    /* Default Disable Giant Packet Size Limit Control */
    ETH_InitParam->GiantPacketSizeLimitCtrl  = (uint32_t)DISABLE;
    ...
    ETH_InitParam->ChecksumOffload           = (uint32_t)DISABLE;
    ...
    ETH_InitParam->ARPOffload                = (uint32_t)DISABLE;
    ...
    ETH_InitParam->DisRxPacketCRCCheck       = (uint32_t)DISABLE;
    /* Default Disable Slow Protocol Detection */
    ETH_InitParam->SPDetect                  = (uint32_t)DISABLE;
    /* Default Disable Unicast Slow Protocol Packet Detect */
    ETH_InitParam->USPPacketDetect           = (uint32_t)DISABLE;
    /* Default Disable Extended Inter-Packet Gap */
    ETH_InitParam->ExtInterPacketGap         = (uint32_t)DISABLE;
    /* Default Set the minimum Inter-Packet Gap value: 0 */
    ETH_InitParam->ExtInterPacketGapVal      = 0U;
    /* Default Disable ARP Packet Drop */
    ETH_InitParam->DropARPPacket             = (uint32_t)DISABLE;

    /* Default Disable Promiscuous Mode */
    ETH_InitParam->Promiscuous               = (uint32_t)DISABLE;
    /* Default Disable Hash Unicast Filtering Mode */
    ETH_InitParam->HashUnicast               = (uint32_t)DISABLE;
    /* Default Disable Hash Multicast Filtering Mode */
    ETH_InitParam->HashMulticast             = (uint32_t)DISABLE;
    /* Default Disable DA Inverse Filtering Mode */
    ETH_InitParam->DAInverseFiltering        = (uint32_t)DISABLE;
    /* Default Disable Pass All Multicast Mode */
    ETH_InitParam->PassAllMulticast          = (uint32_t)DISABLE;
    /* Default Enable Broadcast Packets */
    ETH_InitParam->DisBroadcastPackets       = (uint32_t)DISABLE;
    ...
    ETH_InitParam->SAInverseFiltering        = (uint32_t)DISABLE;
    /* Default Disable SA Filter */
    ETH_InitParam->SAFilter                  = (uint32_t)DISABLE;
    /* Default Disable Hash or Perfect Filter */
    ETH_InitParam->HashOrPerfectFilter       = (uint32_t)DISABLE;
    /* Default Disable VLAN Tag Filter */
    ETH_InitParam->VLANTagFilter             = (uint32_t)DISABLE;
    /* Default Disable Layer 3 and Layer 4 Filter */
    ETH_InitParam->Layer3Layer4Filter        = (uint32_t)DISABLE;
    /* Default Forward Non-TCP/UDP over IP Packets */
    ETH_InitParam->DropNonTcpUdpPackets      = (uint32_t)DISABLE;
    /* Default Disable Receive All mode */
    ETH_InitParam->ReceiveAll                = (uint32_t)DISABLE;
    ...
    ETH_InitParam->ProgramWatchdog           = (uint32_t)DISABLE;

    /* Default Disable Transmit Flow Control function */
    ETH_InitParam->TxFlowControl             = (uint32_t)DISABLE;
    ...
    ETH_InitParam->ForwardUSGoodPacket       = (uint32_t)DISABLE;
    /* Default Disable Forward Error Packets function */
    ETH_InitParam->ForwardErrorPacket        = (uint32_t)DISABLE;
    /* Default Enable Dropping of TCP/IP Checksum Error Packets */
    ETH_InitParam->DisDropTCPIPCSErrorPacket = (uint32_t)DISABLE;
    ...
    ETH_InitParam->DescriptorCache           = (uint32_t)DISABLE;
    ...
    ETH_InitParam->TCPSegment                = (uint32_t)DISABLE;
    ...
    ETH_InitParam->EarlyTxInterruptCtrl      = (uint32_t)DISABLE;
    /* Default Set the maximum number of beats to be transferred in one DMA block data transfer: 1 */
    ETH_InitParam->RxBurstLength             = ETH_RX_PROGRAM_BURST_LEN_1;
    /* Default Disable Early Receive Interrupt function */
    ETH_InitParam->EarlyRxInterruptCtrl      = (uint32_t)DISABLE;
    /* Default Disable Rx Packet Flush function */
    ETH_InitParam->RxPacketFlush             = (uint32_t)DISABLE;
}
...
EthFuncStatusType ETH_ExternalPHYInit(ETH_Module* ETHx, ETH_InfoType* pInfo, ETH_InitType* ETH_InitParam)
{
    ...
    if (ETH_WritePHYRegister(ETHx, (uint32_t)pInfo->PHYInfo.phyAddr,
                             ...
                             (uint32_t)pInfo->PHYInfo.phyReset) == 0U)
    {
        /* Return ERROR */
...
EthFuncStatusType ETH_Init(ETH_Module* ETHx, ETH_InfoType* pInfo, ETH_InitType* ETH_InitParam)
{
    ...
    if (ETHx == ETH1)
    {
        ...
        TempValue = ((uint32_t)(ETH_InitParam->TxPreambleLen)       | (uint32_t)(ETH_InitParam->DeferralCheck)
                     | (uint32_t)(ETH_InitParam->BackOffLimit)        | (uint32_t)(ETH_InitParam->DisTxRetry)
                     | (uint32_t)(ETH_InitParam->DisCSDuringTransmit) | (uint32_t)(ETH_InitParam->DisRxOwn)
                     | (uint32_t)(ETH_InitParam->CSBeforeTransmit)    | (uint32_t)(ETH_InitParam->Loopback)
                     | (uint32_t)(ETH_InitParam->Duplex)              | (uint32_t)(ETH_InitParam->SpeedSelect)
                     | (uint32_t)(ETH_InitParam->JumboPacket)         | (uint32_t)(ETH_InitParam->DisTxJabber)
                     | (uint32_t)(ETH_InitParam->PacketBurst)
                     | (uint32_t)(ETH_InitParam->DisRxWatchdog)       | (uint32_t)(ETH_InitParam->AutoPadCRCStrip)
                     | (uint32_t)(ETH_InitParam->CRCStripTypePacket)  | (uint32_t)(ETH_InitParam->Support2KPacket)
                     | (uint32_t)(ETH_InitParam->GiantPacketSizeLimitCtrl)
                     | (uint32_t)(ETH_InitParam->InterPacketGapVal)   | (uint32_t)(ETH_InitParam->ChecksumOffload)
                     | (uint32_t)(ETH_InitParam->SrcAddrCtrl)         | (uint32_t)(ETH_InitParam->ARPOffload));
        /* Write to ETH_MACCFG */
    ...
    TempValue = ((uint32_t)(ETH_InitParam->GiantPacketSizeLimit) | (uint32_t)(ETH_InitParam->DisRxPacketCRCCheck)
                 | (uint32_t)(ETH_InitParam->SPDetect)             | (uint32_t)(ETH_InitParam->USPPacketDetect)
                 | (uint32_t)(ETH_InitParam->ExtInterPacketGap)    | (uint32_t)(ETH_InitParam->ExtInterPacketGapVal)
                 | (uint32_t)(ETH_InitParam->DropARPPacket));
    ...
    TempValue = ((uint32_t)(ETH_InitParam->Promiscuous)         | (uint32_t)(ETH_InitParam->HashUnicast)
                 | (uint32_t)(ETH_InitParam->HashMulticast)       | (uint32_t)(ETH_InitParam->DAInverseFiltering)
                 | (uint32_t)(ETH_InitParam->PassAllMulticast)    | (uint32_t)(ETH_InitParam->DisBroadcastPackets)
                 | (uint32_t)(ETH_InitParam->PassControlPackets)  | (uint32_t)(ETH_InitParam->SAInverseFiltering)
                 | (uint32_t)(ETH_InitParam->SAFilter)            | (uint32_t)(ETH_InitParam->HashOrPerfectFilter)
                 | (uint32_t)(ETH_InitParam->VLANTagFilter)       | (uint32_t)(ETH_InitParam->Layer3Layer4Filter)
                 | (uint32_t)(ETH_InitParam->DropNonTcpUdpPackets) | (uint32_t)(ETH_InitParam->ReceiveAll));
    ...
    TempValue = ((uint32_t)(ETH_InitParam->WatchdogTimeout) | (uint32_t)(ETH_InitParam->ProgramWatchdog));
    ...
    DZPQ, PT bits */
    TempValue = ((uint32_t)(ETH_InitParam->TxFlowControl)      | (uint32_t)(ETH_InitParam->PauseLowThreshold)
                 | (uint32_t)(ETH_InitParam->DisZeroQuantaPause) | (uint32_t)(ETH_InitParam->PauseTime));
    ...
    TempValue = ((uint32_t)(ETH_InitParam->RxFlowControl) | (uint32_t)(ETH_InitParam->UPPacketDetect));
    ...
    TempValue = (uint32_t)(ETH_InitParam->TxQueueOperateMode);
    ...
    RSF, DISTCPEF bits */
    TempValue = ((uint32_t)(ETH_InitParam->RxQueueOperateMode) | (uint32_t)(ETH_InitParam->ForwardUSGoodPacket)
                 | (uint32_t)(ETH_InitParam->ForwardErrorPacket) | (uint32_t)(ETH_InitParam->DisDropTCPIPCSErrorPacket));
    ...
    TempValue = (uint32_t)(ETH_InitParam->TxRxArbitration | (uint32_t)(ETH_InitParam->DescriptorCache));
    ...
    TempValue = ((uint32_t)(ETH_InitParam->BurstMode) | (uint32_t)(ETH_InitParam->AddrAlignedBeats)
                 | (uint32_t)(ETH_InitParam->RebuildINCRxBurst));
    ...
    TempValue = ((uint32_t)(ETH_InitParam->MaxSegmentSize) | (uint32_t)(ETH_InitParam->PBLx8mode)
                 | (uint32_t)(ETH_InitParam->DescriptorSkipLen));
    ...
    TempValue = ((uint32_t)(ETH_InitParam->OperateSecondPacket) | (uint32_t)(ETH_InitParam->TCPSegment)
                 | (uint32_t)(ETH_InitParam->TxBurstLength)       | (uint32_t)(ETH_InitParam->EarlyTxInterruptCtrl));
    ...
    TempValue = ((uint32_t)(ETH_InitParam->RxBurstLength) | (uint32_t)(ETH_InitParam->EarlyRxInterruptCtrl)
                 | (uint32_t)(ETH_InitParam->RxPacketFlush));
...
*\*\fun     Initializes the structure parameter of type ETH_RxVLANTagType used to
*\*\        initialize VLAN tag. This function is usually called before initializing
*\*\        a parameter of type ETH_RxVLANTagType.
*\*\param   ETH_InitParam :
*\*\          - Pointer to the ETH_RxVLANTagType structure which will be initialized.
*\*\return  none
**/
void ETH_RxVLANTagStructInit(ETH_RxVLANTagType* ETH_RxVTInitParam)
{
    ...
    /* Default Disable Inner VLAN Tag in Rx Status */
    ETH_RxVTInitParam->InnerVLANTagInStatus   = (uint32_t)DISABLE;
    /* Default Inner VLAN Tag not Stripping on Receive */
    ETH_RxVTInitParam->StripInnerVLANTag      = ETH_INNERVLANTAGRXSTRIPPING_NONE;
    /* Default Disable Inner VLAN Tag */
    ETH_RxVTInitParam->InnerVLANTag           = (uint32_t)DISABLE;
    /* Default Disable Double VLAN Processing */
    ETH_RxVTInitParam->DoubleVLANProcessing   = (uint32_t)DISABLE;
    /* Default Disable VLAN Tag Hash Table Match */
    ETH_RxVTInitParam->VLANTagHashTableMatch  = (uint32_t)DISABLE;
    /* Default Disable VLAN Tag in Rx status */
    ETH_RxVTInitParam->VLANTagInStatus        = (uint32_t)DISABLE;
    ...
    ETH_RxVTInitParam->VLANTagInverceMatch    = (uint32_t)DISABLE;
    /* Default Disable 12-Bit VLAN Tag Comparison */
    ETH_RxVTInitParam->VLANTagComparison12Bit = (uint32_t)DISABLE;
}

/**
*\*\name    ETH_ConfigRxVLANTag.
*\*\fun     Configure VLAN tag processing on the receiving path.
*\*\param   ETHx (The input parameters must be the following values):
*\*\          - ETH1
*\*\          - ETH2
*\*\param   pRxVLANTag :
*\*\          - Pointer to a structure which will be initialized.
*\*\return  One of EthFuncStatusType.
**/
EthFuncStatusType ETH_ConfigRxVLANTag(ETH_Module* ETHx, ETH_RxVLANTagType* pRxVLANTag)
{
    ...
    /* Configure the ETH_MACVLANTAG register, including setting EIVLRXS, EIVLS[1:0],
    ERIVLT, EDVLP, VTHM, EVLRXS, EVLS, DOVLTC, ERSVLM, ESVL, VTIM, ETV, VL[15:0] bits */
    TempValue = ((uint32_t)(pRxVLANTag->InnerVLANTagInStatus) | (uint32_t)(pRxVLANTag->StripInnerVLANTag)
                 | (uint32_t)(pRxVLANTag->InnerVLANTag)         | (uint32_t)(pRxVLANTag->DoubleVLANProcessing)
                 | (uint32_t)(pRxVLANTag->VLANTagInStatus)      | (uint32_t)(pRxVLANTag->VLANTagHashTableMatch)
                 | (uint32_t)(pRxVLANTag->StripVLANTag)         | (uint32_t)(pRxVLANTag->VLANTypeCheck)
                 | (uint32_t)(pRxVLANTag->VLANTagInverceMatch)  | (uint32_t)(pRxVLANTag->VLANTagComparison12Bit));
...
/**
*\*\name    ETH_TxVLANTagStructInit.
*\*\fun     Initializes the structure parameter of type ETH_TxVLANTagType used to
*\*\        initialize VLAN tag. This function is usually called before initializing
*\*\        a parameter of type ETH_TxVLANTagType.
*\*\param   ETH_InitParam :
*\*\          - Pointer to the ETH_TxVLANTagType structure which will be initialized.
*\*\return  none
**/
void ETH_TxVLANTagStructInit(ETH_TxVLANTagType* ETH_TxVTInitParam)
{
    ...
    /* Default Disable VLAN Tag Input on Transmit */
    ETH_TxVTInitParam->VLANTagInput         = (uint32_t)DISABLE;
    /* Default C-VLAN on Transmit */
    ETH_TxVTInitParam->VLANType             = ETH_TXVLAN_CVLAN;
    /* Default No VLAN tag deletion, insertion, or replacement on Transmit */
    ETH_TxVTInitParam->VLANTagCtrl          = ETH_TXVLANTAGCONTROL_NONE;
}

/**
*\*\name    ETH_ConfigTxOuterVLANTag.
*\*\fun     Configure Outer VLAN tag processing on the transmit path.
*\*\param   ETHx (The input parameters must be the following values):
*\*\          - ETH1
*\*\          - ETH2
*\*\param   pRxVLANTag :
...
EthFuncStatusType ETH_ConfigTxOuterVLANTag(ETH_Module* ETHx, ETH_TxVLANTagType* pTxVLANTag)
{
    ...
    /* Configure the ETH_MACVLANINC register, including setting VLTI, CSVL, VLP,
    VLC[1:0] bits */
    TempValue = ((uint32_t)(pTxVLANTag->VLANTagInput) | (uint32_t)(pTxVLANTag->VLANType)
                 | (uint32_t)(pTxVLANTag->VLANTagCtrl));
    /* Write to ETH_MACVLANINC */
    MODIFY_REG(ETHx->MACVLANINC, ETH_MACVLANINC_MASK, TempValue);
...
/**
*\*\name    ETH_ConfigTxInnerVLANTag.
*\*\fun     Configure Inner VLAN tag processing on the transmit path.
*\*\param   ETHx (The input parameters must be the following values):
*\*\          - ETH1
*\*\          - ETH2
*\*\param   pRxVLANTag :
...
EthFuncStatusType ETH_ConfigTxInnerVLANTag(ETH_Module* ETHx, ETH_TxVLANTagType* pTxVLANTag)
{
    ...
    /* Configure the ETH_MACIVLANINC register, including setting VLTI, CSVL, VLP,
    VLC[1:0] bits */
    TempValue = ((uint32_t)(pTxVLANTag->VLANTagInput) | (uint32_t)(pTxVLANTag->VLANType)
                 | (uint32_t)(pTxVLANTag->VLANTagCtrl));
    /* Write to ETH_MACIVLANINC */
    MODIFY_REG(ETHx->MACIVLANINC, ETH_MACIVLANINC_MASK, TempValue);

    /* Enable Double VLAN processing */
    SET_BIT(ETHx->MACVLANTAG, ETH_MACVLANTAG_EDVLP);
...
/**
*\*\name    ETH_SetTxOuterVLANIdentifier.
*\*\fun     Set the Outer VLAN Identifier for Tx packets.
*\*\param   ETHx (The input parameters must be the following values):
*\*\          - ETH1
*\*\          - ETH2
*\*\param   VLANIdentifier :
...
{
    /* Write to ETH_MACVLANINC */
    MODIFY_REG(ETHx->MACVLANINC, ETH_MACVLANINC_VLT, VLANIdentifier);
}

/**
*\*\name    ETH_SetTxInnerVLANIdentifier.
*\*\fun     Set the Inner VLAN Identifier for Tx packets.
*\*\param   ETHx (The input parameters must be the following values):
*\*\          - ETH1
*\*\          - ETH2
*\*\param   VLANIdentifier :
...
{
    /* Write to ETH_MACIVLANINC */
    MODIFY_REG(ETHx->MACIVLANINC, ETH_MACIVLANINC_VLT, VLANIdentifier);
}

/**
*\*\name    ETH_VLANFilteringCmd.
*\*\fun     Enables or disables the VLAN Tag Filtering process.
*\*\param   ETHx (The input parameters must be the following values):
*\*\          - ETH1
*\*\          - ETH2
*\*\param   Cmd (The input parameters must be the following values):
...
void ETH_VLANFilteringCmd(ETH_Module* ETHx, FunctionalStatus Cmd)
{
    if (Cmd != DISABLE)
    {
        /* Enable VLAN Filtering process */
        SET_BIT(ETHx->MACPFLT, ETH_MACPFLT_VTFE);
    }
    else
    {
        /* Disable VLAN Filtering process */
        CLEAR_BIT(ETHx->MACPFLT, ETH_MACPFLT_VTFE);
    }
}
...
/**
*\*\name    ETH_EnterLPIMode.
*\*\fun     Enters the Low Power Idle (LPI) mode.
*\*\param   ETHx (The input parameters must be the following values):
*\*\          - ETH1
*\*\          - ETH2
*\*\param   TxClockStop (The input parameters must be the following values):
*\*\          - ETH_LPITXCLKSTOP_ENABLE
*\*\          - ETH_LPITXCLKSTOP_DISABLE
*\*\param   TxAutomate (The input parameters must be the following values):
*\*\          - ETH_LPITXAUTOMATE_ENABLE
*\*\          - ETH_LPITXAUTOMATE_DISABLE
*\*\return  none
**/
void ETH_EnterLPIMode(ETH_Module* ETHx, EthLPITxClkType TxClockStop, EthLPITxAutoType TxAutomate)
{
    ...
    /* Configure the ETH_MACLPICTRLSTS register, including setting LPITCSE, LPITXA, LPIEN, bits */
    TempValue = ((uint32_t)(TxClockStop) | (uint32_t)(TxAutomate) | ETH_MACLPICTRLSTS_LPIEN);
    /* Write to ETH_MACLPICTRLSTS register: Enter low power mode */
    MODIFY_REG(ETHx->MACLPICTRLSTS, ETH_MACLPICTRLSTS_MASK, TempValue);
}

/**
*\*\name    ETH_ExitLPIMode.
*\*\fun     Exits the Low Power Idle (LPI) mode.
*\*\param   ETHx (The input parameters must be the following values):
*\*\          - ETH1
*\*\          - ETH2
*\*\return  none
...
void ETH_ExitLPIMode(ETH_Module* ETHx)
{
    ...
    CLEAR_BIT(ETHx->MACLPICTRLSTS, (ETH_MACLPICTRLSTS_LPIEN
                                    | ETH_MACLPICTRLSTS_LPITXA
                                    | ETH_MACLPICTRLSTS_LPITCSE));
}

/**
*\*\name    ETH_SetARPAddressMatch.
*\*\fun     Set the ARP Match IP address. This address is used to achieve a
*\*\        perfect match with the destination protocol address field in the
*\*\        received ARP packet
*\*\param   ETHx (The input parameters must be the following values):
*\*\          - ETH1
*\*\          - ETH2
*\*\param   IpAddress:
*\*\          - IP Address to be matched for incoming ARP requests
*\*\return  none
**/
void ETH_SetARPAddressMatch(ETH_Module* ETHx, uint32_t IpAddress)
{
    /* Write to MAC ARP Address register */
    WRITE_REG(ETHx->MACARPADDR, IpAddress);
}
...
void ETH_SetMACAddress(ETH_Module* ETHx, EthMacAddr0123Type Offset, uint8_t* pAddr)
{
    ...
    (*(__IO uint32_t *)(macAddrRegBaseH + (uint32_t)Offset)) = TempValue;

    /* Set MAC addr low bits (0~31) */
    TempValue = (((uint32_t)(pAddr[3]) << 24) | ((uint32_t)(pAddr[2]) << 16) |
                 ((uint32_t)(pAddr[1]) << 8) | (uint32_t)pAddr[0]);
    (*(__IO uint32_t *)(macAddrRegBaseL + (uint32_t)Offset)) = TempValue;
}
...
void ETH_GetMACAddress(ETH_Module* ETHx, EthMacAddr0123Type Offset, uint8_t* pAddr)
{
    ...
    TempValue = *(__IO uint32_t *)(macAddrRegBaseH + (uint32_t)Offset);
    ...
    TempValue = *(__IO uint32_t *)(macAddrRegBaseL + (uint32_t)Offset);
...
void ETH_MACAddressPerfectFilterCmd(ETH_Module* ETHx, EthMacAddr123Type Offset, FunctionalStatus Cmd)
{
    ...
    if (Cmd != DISABLE)
    {
        ...
        (*(__IO uint32_t *)(macAddrRegBaseH + (uint32_t)Offset)) |= ETH_MACADDR1H_AE;
    }
    else
    {
...
void ETH_SetMACAddressFilter(ETH_Module* ETHx, EthMacAddr123Type Offset, EthMacAddrFilterType Filter)
{
    ...
    if (Filter != ETH_MACADDR_FILTER_DA)
    {
        ...
        received frame */
        (*(__IO uint32_t *)(macAddrRegBaseH + (uint32_t)Offset)) |= ETH_MACADDR1H_SA;
    }
    else
    {
...
void ETH_SetMACAddressFilterMaskBytes(ETH_Module* ETHx, EthMacAddr123Type Offset, uint32_t MaskByte)
{
    ...
    (*(__IO uint32_t*)(macAddrRegBaseH + (uint32_t)Offset)) &= (~ETH_MACADDR_MASK_MBC);

    /* Set the selected Filetr mask bytes */
    (*(__IO uint32_t*)(macAddrRegBaseH + (uint32_t)Offset)) |= MaskByte;
}

/**
*\*\name    ETH_MACAddress1Filter.
*\*\fun     Use MAC address 1 to implement filtering.
*\*\param   ETHx (The input parameters must be the following values):
*\*\          - ETH1
*\*\          - ETH2
*\*\param   Filter (The input parameters must be the following values):
...
*\*\          - Pointer on MAC address buffer
*\*\return  none
*\*\note    For correct synchronous updates, the MAC address high register (including
*\*\        the address enable bit AE) must be configured first, followed by the MAC
...
void ETH_MACAddress1Filter(ETH_Module* ETHx, EthMacAddrFilterType Filter, uint32_t MaskByte, uint8_t* pAddr)
{
    ...
    /* Set the selected Filetr mask bytes */
    TempValue |= MaskByte;
    /* SA or DA field selection */
    if (Filter != ETH_MACADDR_FILTER_DA)
    {
        /* Compare with the SA field of the received packet */
        TempValue |= ETH_MACADDR1H_SA;
    }
    else
    {
        /* Compare with the DA field of the received packet */
        TempValue &= (~ETH_MACADDR1H_SA);
    }
    /* Enable the MAC address for filtering */
    TempValue |= ETH_MACADDR1H_AE;
    /* Write to MAC address high register */
    WRITE_REG(ETHx->MACADDR1H, TempValue);

    /* Set MAC addr low bits (0~31) */
    TempValue = (((uint32_t)(pAddr[3]) << 24) | ((uint32_t)(pAddr[2]) << 16) |
                 ((uint32_t)(pAddr[1]) << 8) | (uint32_t)pAddr[0]);
    /* Write to MAC address low register */
    WRITE_REG(ETHx->MACADDR1L, TempValue);
}

/**
*\*\name    ETH_MACAddress2Filter.
*\*\fun     Use MAC address 2 to implement filtering.
*\*\param   ETHx (The input parameters must be the following values):
*\*\          - ETH1
*\*\          - ETH2
*\*\param   Filter (The input parameters must be the following values):
...
void ETH_MACAddress2Filter(ETH_Module* ETHx, EthMacAddrFilterType Filter, uint32_t MaskByte, uint8_t* pAddr)
{
    ...
    /* Enable the MAC address for filtering */
    TempValue |= ETH_MACADDR2H_AE;
    /* Write to MAC address high register */
    WRITE_REG(ETHx->MACADDR2H, TempValue);

    /* Set MAC addr low bits (0~31) */
    TempValue = (((uint32_t)(pAddr[3]) << 24) | ((uint32_t)(pAddr[2]) << 16) |
                 ((uint32_t)(pAddr[1]) << 8) | (uint32_t)pAddr[0]);
    /* Write to MAC address low register */
    WRITE_REG(ETHx->MACADDR2L, TempValue);
}

/**
*\*\name    ETH_MACAddress3Filter.
*\*\fun     Use MAC address 3 to implement filtering.
*\*\param   ETHx (The input parameters must be the following values):
*\*\          - ETH1
*\*\          - ETH2
*\*\param   Filter (The input parameters must be the following values):
...
void ETH_MACAddress3Filter(ETH_Module* ETHx, EthMacAddrFilterType Filter, uint32_t MaskByte, uint8_t* pAddr)
{
    ...
    /* Enable the MAC address for filtering */
    TempValue |= ETH_MACADDR3H_AE;
    /* Write to MAC address high register */
    WRITE_REG(ETHx->MACADDR3H, TempValue);

    /* Set MAC addr low bits (0~31) */
    TempValue = (((uint32_t)(pAddr[3]) << 24) | ((uint32_t)(pAddr[2]) << 16) |
                 ((uint32_t)(pAddr[1]) << 8) | (uint32_t)pAddr[0]);
    /* Write to MAC address low register */
    WRITE_REG(ETHx->MACADDR3L, TempValue);
}
...
uint32_t ETH_GetMMCCounterValue(ETH_Module* ETHx, EthMmcAddrType Offset)
{
    ...
    return (*(__IO uint32_t *)(mmcRegBaseAddr + (uint32_t)Offset));
}

/**
*\*\name    ETH_ConfigL3Filter0.
*\*\fun     Configures the L3 Filter 0, this function allow to:
...
*\*\          - ETH2
*\*\param   pL3Filter :
*\*\          - Pointer to a structure that contains L3 filter configuration.
*\*\return  One of EthFuncStatusType.
**/
EthFuncStatusType ETH_ConfigL3Filter0(ETH_Module* ETHx, ETH_L3FilterType* pL3Filter)
{
    ...
    /* Configure the ETH_MACL3L4F0CTRL register, including setting L3PEN,
    L3SAM, L3SAIM, L3DAM, L3DAIM, L3HSBM[4:0], L3HDBM[4:0] bits */
    TempValue = ((uint32_t)(pL3Filter->Protocol)
                 | (uint32_t)(pL3Filter->SrcAddrFilterMatch)
                 | (uint32_t)(pL3Filter->DestAddrFilterMatch)
                 | (uint32_t)(pL3Filter->SrcAddrHigherBitsMatch << 6U)
                 | (uint32_t)(pL3Filter->DestAddrHigherBitsMatch << 11U));
    /* Write to ETH_MACL3L4F0CTRL */
    MODIFY_REG(ETHx->MACL3L4F0CTRL, ETH_MACL3L4F0CTRL_MASK, TempValue);

    /* Check if IPv6 protocol is selected */
    if (pL3Filter->Protocol == ETH_L3_PROTOCOL_IPV6)
    {
        /* Set the IPv6 source/destination address match */
        {
            /* Set Bits[31:0] of 128-bit IP addr */
            WRITE_REG(ETHx->MACL3F0ADDR0, pL3Filter->Ip6Addr[0]);
            /* Set Bits[63:32] of 128-bit IP addr */
            WRITE_REG(ETHx->MACL3F0ADDR1, pL3Filter->Ip6Addr[1]);
            /* Set Bits[95:64] of 128-bit IP addr */
            WRITE_REG(ETHx->MACL3F0ADDR2, pL3Filter->Ip6Addr[2]);
            /* Set Bits[127:96] of 128-bit IP addr */
            WRITE_REG(ETHx->MACL3F0ADDR3, pL3Filter->Ip6Addr[3]);
        }
    }
    else
    {
        /* Set the IPv4 source address match */
        WRITE_REG(ETHx->MACL3F0ADDR0, pL3Filter->Ip4SrcAddr);
        /* Set the IPv4 destination address match */
        WRITE_REG(ETHx->MACL3F0ADDR1, pL3Filter->Ip4DestAddr);
    }
...
/**
*\*\name    ETH_ConfigL3Filter1.
*\*\fun     Configures the L3 Filter 1, this function allow to:
*\*\        Set the layer 3 protocol to be matched (IPv4 or IPv6),
*\*\        enable/disable L3 source/destination port perfect/inverse match.
*\*\param   ETHx (The input parameters must be the following values):
*\*\          - ETH1
...
EthFuncStatusType ETH_ConfigL3Filter1(ETH_Module* ETHx, ETH_L3FilterType* pL3Filter)
{
    ...
    /* Configure the ETH_MACL3L4F1CTRL register, including setting L3PEN,
    L3SAM, L3SAIM, L3DAM, L3DAIM, L3HSBM[4:0], L3HDBM[4:0] bits */
    TempValue = ((uint32_t)(pL3Filter->Protocol)
                 | (uint32_t)(pL3Filter->SrcAddrFilterMatch)
                 | (uint32_t)(pL3Filter->DestAddrFilterMatch)
                 | (uint32_t)(pL3Filter->SrcAddrHigherBitsMatch << 6U)
                 | (uint32_t)(pL3Filter->DestAddrHigherBitsMatch << 11U));
    /* Write to ETH_MACL3L4F1CTRL */
    MODIFY_REG(ETHx->MACL3L4F1CTRL, ETH_MACL3L4F1CTRL_MASK, TempValue);
    ...
    if (pL3Filter->Protocol == ETH_L3_PROTOCOL_IPV6)
    {
        ...
        {
            /* Set Bits[31:0] of 128-bit IP addr */
            WRITE_REG(ETHx->MACL3F1ADDR0, pL3Filter->Ip6Addr[0]);
            /* Set Bits[63:32] of 128-bit IP addr */
            WRITE_REG(ETHx->MACL3F1ADDR1, pL3Filter->Ip6Addr[1]);
            /* Set Bits[95:64] of 128-bit IP addr */
            WRITE_REG(ETHx->MACL3F1ADDR2, pL3Filter->Ip6Addr[2]);
            /* Set Bits[127:96] of 128-bit IP addr */
            WRITE_REG(ETHx->MACL3F1ADDR3, pL3Filter->Ip6Addr[3]);
        }
    }
    else
    {
        /* Set the IPv4 source address match */
        WRITE_REG(ETHx->MACL3F1ADDR0, pL3Filter->Ip4SrcAddr);
        /* Set the IPv4 destination address match */
        WRITE_REG(ETHx->MACL3F1ADDR1, pL3Filter->Ip4DestAddr);
    }
...
/**
*\*\name    ETH_ConfigL4Filter0.
*\*\fun     Configures the L4 Filter 0, this function allow to:
...
*\*\          - ETH2
*\*\param   pL4Filter :
*\*\          - Pointer to a structure that contains L4 filter configuration.
*\*\return  One of EthFuncStatusType.
**/
EthFuncStatusType ETH_ConfigL4Filter0(ETH_Module* ETHx, ETH_L4FilterType* pL4Filter)
{
    ...
    /* Configure the ETH_MACL3L4F0CTRL register, including setting L4SPM,
    L4SPIM, L4DPM, L4DPIM bits */
    TempValue = ((uint32_t)(pL4Filter->Protocol)
                 | (uint32_t)(pL4Filter->SrcPortFilterMatch)
                 | (uint32_t)(pL4Filter->DestPortFilterMatch));
    /* Write to ETH_MACL3L4F0CTRL */
    MODIFY_REG(ETHx->MACL3L4F0CTRL, ETH_MACL3L4F0CTRL_MASK, TempValue);

    /* Set the source/destination port match */
    WRITE_REG(ETHx->MACL4F0PORT, (pL4Filter->SrcPort | (pL4Filter->DestPort << 16U)));
...
/**
*\*\name    ETH_ConfigL4Filter1.
*\*\fun     Configures the L4 Filter 1, this function allow to:
*\*\        Set the layer 4 protocol to be matched (TCP or UDP),
*\*\        enable/disable L4 source/destination port perfect/inverse match.
*\*\param   ETHx (The input parameters must be the following values):
*\*\          - ETH1
...
EthFuncStatusType ETH_ConfigL4Filter1(ETH_Module* ETHx, ETH_L4FilterType* pL4Filter)
{
    ...
    /* Configure the ETH_MACL3L4F1CTRL register, including setting L4SPM,
    L4SPIM, L4DPM, L4DPIM bits */
    TempValue = ((uint32_t)(pL4Filter->Protocol)
                 | (uint32_t)(pL4Filter->SrcPortFilterMatch)
                 | (uint32_t)(pL4Filter->DestPortFilterMatch));
    ...
    /* Set the source/destination port match */
    WRITE_REG(ETHx->MACL4F1PORT, (pL4Filter->SrcPort | (pL4Filter->DestPort << 16U)));
...
/**
*\*\name    ETH_L3L4FilteringCmd.
*\*\fun     Enables or disables L3 and L4 filtering process.
*\*\param   ETHx (The input parameters must be the following values):
*\*\          - ETH1
*\*\          - ETH2
*\*\param   Cmd (The input parameters must be the following values):
...
void ETH_L3L4FilteringCmd(ETH_Module* ETHx, FunctionalStatus Cmd)
{
    ...
    {
        /* Enable L3/L4 filter */
        SET_BIT(ETHx->MACPFLT, ETH_MACPFLT_IPFE);
    }
    else
    {
        /* Disable L3/L4 filter */
        CLEAR_BIT(ETHx->MACPFLT, ETH_MACPFLT_IPFE);
    }
}
...
uint32_t ETH_GetTimeStampRegValue(ETH_Module* ETHx, EthTsAddrType Offset)
{
    ...
    return (*(__IO uint32_t *)(tsRegBaseAddr + (uint32_t)Offset));
}
...
EthFuncStatusType ETH_BuildRxDescriptors(ETH_Module* ETHx, ETH_InfoType* pInfo)
{
    ...
    for (TempIndex = 0; TempIndex < TotalAppDescNbr; TempIndex++)
    {
        ...
        if (TempIndex < (TotalAppDescNbr - 1U))
        {
    ...
    /* Reset the context desc number */
    pRxDescList->AppContextDesc = 0U;
...
EthFuncStatusType ETH_PrepareTxDescriptors(ETH_Module* ETHx, ETH_InfoType* pInfo, ETH_TxPacketType* pTxPacket, uint32_t ItMode)
{
    ...
    /* Starting to configure TX context descriptors */
    {
        ...
        if ((pTxPacket->Attributes & (uint32_t)ETH_TX_PACKETS_FEATURES_VLANTAG) != (uint32_t)RESET)
        {
            /* Set vlan tag value */
            MODIFY_REG(pTxDescriptor->DESC3, ETH_DMATXCD3_VT, pTxPacket->VlanTag);
            /* Set vlan tag valid bit */
            SET_BIT(pTxDescriptor->DESC3, ETH_DMATXCD3_VLTV);
            /* Set the descriptor as the vlan input source */
            SET_BIT(ETHx->MACVLANINC, ETH_MACVLANINC_VLTI);

            /* If inner VLAN is enabled for this packet */
            if ((pTxPacket->Attributes & (uint32_t)ETH_TX_PACKETS_FEATURES_INNERVLANTAG) != (uint32_t)RESET)
            {
                /* Set inner vlan tag value */
                MODIFY_REG(pTxDescriptor->DESC2, ETH_DMATXCD2_IVT, (pTxPacket->InnerVlanTag << 16U));
                /* Set inner vlan tag valid bit */
                SET_BIT(pTxDescriptor->DESC3, ETH_DMATXCD3_IVLTV);

                /* Set Vlan Tag control */
                MODIFY_REG(pTxDescriptor->DESC3, ETH_DMATXCD3_IVTIR, pTxPacket->InnerVlanCtrl);

                /* Set the descriptor as the inner vlan input source */
                SET_BIT(ETHx->MACIVLANINC, ETH_MACIVLANINC_VLTI);
                /* Enable double VLAN processing */
                SET_BIT(ETHx->MACVLANTAG, ETH_MACVLANTAG_EDVLP);
            }
        }
        ...
        if ((pTxPacket->Attributes & (uint32_t)ETH_TX_PACKETS_FEATURES_TSO) != (uint32_t)RESET)
        {
            /* Set MSS value */
            MODIFY_REG(pTxDescriptor->DESC2, ETH_DMATXCD2_MSS, pTxPacket->MaxSegmentSize);
            /* Set MSS valid bit */
            SET_BIT(pTxDescriptor->DESC3, ETH_DMATXCD3_TCMSSV);
        }

        /* If One-Step Timestamp Correction is enabled for this packet */
        if ((pTxPacket->Attributes & (uint32_t)ETH_TX_PACKETS_FEATURES_OSTC) != (uint32_t)RESET)
        {
        ...
        if (((pTxPacket->Attributes & (uint32_t)ETH_TX_PACKETS_FEATURES_VLANTAG)  != (uint32_t)RESET)
                || ((pTxPacket->Attributes & (uint32_t)ETH_TX_PACKETS_FEATURES_TSO)  != (uint32_t)RESET)
                || ((pTxPacket->Attributes & (uint32_t)ETH_TX_PACKETS_FEATURES_OSTC) != (uint32_t)RESET))
        {
    ...
    /* Starting to configure TX Normal descriptor */
    {
        ...
        if (pTxBuf->pNext != NULL)
        {
            ...
            /* Set buffer 2 Length */
            MODIFY_REG(pTxDescriptor->DESC2, ETH_DMATXND2RF_B2L, (pTxBuf->Len << 16U));
        }
        else
        {
            ...
            MODIFY_REG(pTxDescriptor->DESC2, ETH_DMATXND2RF_B2L, 0U);
        }
        ...
        if ((pTxPacket->Attributes & (uint32_t)ETH_TX_PACKETS_FEATURES_TSO) != (uint32_t)RESET)
        {
            ...
            MODIFY_REG(pTxDescriptor->DESC3, ETH_DMATXND3RF_THL, (pTxPacket->TCPHeaderLen << 19U));
            /* Set TCP payload length */
            MODIFY_REG(pTxDescriptor->DESC3, ETH_DMATXND3RF_TPL, pTxPacket->PayloadLen);
            /* Set TCP Segmentation Enabled bit */
            SET_BIT(pTxDescriptor->DESC3, ETH_DMATXND3RF_TSE);
        }
        else
        {
            /* Set Frame Length */
            ...
            if ((pTxPacket->Attributes & (uint32_t)ETH_TX_PACKETS_FEATURES_CSUM) != (uint32_t)RESET)
            {
            ...
            if ((pTxPacket->Attributes & (uint32_t)ETH_TX_PACKETS_FEATURES_CRCPAD) != (uint32_t)RESET)
            {
        ...
        {
            /* Set Vlan Tag control */
            MODIFY_REG(pTxDescriptor->DESC2, ETH_DMATXND2RF_VTIR, pTxPacket->VlanCtrl);
        }

        /* If Source Address Control is enabled for this packet */
        if ((pTxPacket->Attributes & (uint32_t)ETH_TX_PACKETS_FEATURES_SAIC) != (uint32_t)RESET)
        {
            /* Set Source Address Insertion Control bits */
            MODIFY_REG(pTxDescriptor->DESC3, ETH_DMATXND3RF_SAIC, pTxPacket->SAInsertCtrl);
        }

        /* If Transmit Timestamp is enabled for this packet */
        if ((pTxPacket->Attributes & (uint32_t)ETH_TX_PACKETS_FEATURES_TTSE) != (uint32_t)RESET)
        {
            /* Set Source Address Insertion Control bits */
            SET_BIT(pTxDescriptor->DESC2, ETH_DMATXND2RF_TTSE);
        }
...
*\*\          - Pointer to an ETH_InfoType structure parameter containing various
*\*\            information about the operation of the ETH module.
*\*\return  0 or length of last received Packet.
**/
    ...
    else
    {
        if ((pRxDescriptor->DESC3 & ETH_DMARXND3WBF_RS0V) != (uint32_t)RESET)
        {
            ...
            if ((pRxDescriptor->DESC3 & ETH_DMARXND3WBF_LT) == ETH_DMARXND3WBF_LT_DVLAN)
            {
                ...
                /* Get Inner VLAN Tag */
                pRxPacket->InnerVlanTag = READ_BIT(pRxDescriptor->DESC0, ETH_DMARXND0WBF_IVT) >> 16U;
            }
            else
            {
                /* Get Outer VLAN Tag */
        ...
        if ((pRxDescriptor->DESC3 & ETH_DMARXND3WBF_RS1V) != (uint32_t)RESET)
        {
            ...
            /* Get Header type */
            pRxPacket->HeaderType  = READ_BIT(pRxDescriptor->DESC1, (ETH_DMARXND1WBF_IPV4
                                              | ETH_DMARXND1WBF_IPV6));
            /* Get Checksum status */
            pRxPacket->Checksum    = READ_BIT(pRxDescriptor->DESC1, (ETH_DMARXND1WBF_IPHE
        ...
        if ((pRxDescriptor->DESC3 & ETH_DMARXND3WBF_RS2V) != (uint32_t)RESET)
        {
            ...
            pRxPacket->MACFilterStatus = READ_BIT(pRxDescriptor->DESC2, (ETH_DMARXND2WBF_VFS
                                                  ...
                                                  | ETH_DMARXND2WBF_DAF
                                                  | ETH_DMARXND2WBF_HF));
            /* Get L3 Filter Status */
            pRxPacket->L3FilterStatus  = READ_BIT(pRxDescriptor->DESC2, (ETH_DMARXND2WBF_L3FM
                                                  | ETH_DMARXND2WBF_L3L4FM));
            /* Get L4 Filter Status */
            pRxPacket->L3FilterStatus  = READ_BIT(pRxDescriptor->DESC2, (ETH_DMARXND2WBF_L4FM
                                                  | ETH_DMARXND2WBF_L3L4FM));
        }
    }
...
*\*\          - ETH_DMARXDESC_EXTFLAG_PT_UDP
*\*\          - ETH_DMARXDESC_EXTFLAG_PT_TCP
*\*\          - ETH_DMARXDESC_EXTFLAG_PT_ICMP
